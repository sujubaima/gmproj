...
PERSON_XIE_HUI = \
    {"firstname": "谢", "lastname": "蕙", "title": "百兵堂玉剑舵舵主",
     "hp_max":4000, "mp_max": 2500, "attack": 336, "defense": 360, "motion": 1,
     ...
     "superskills": [{"id": "SUPERSKILL_JINGUANYUSUOJUE", "learn": "All"},
...
PERSON_SONG_TIANYONG = \
    {"firstname": "宋", "lastname": "天勇", "title": "百兵堂铁枪舵舵主",
     "hp_max":4500, "mp_max": 2100, "attack": 360, "defense": 300, "motion": 0,
     ...
     "criticaltxt": "隐隐感觉自己的枪法要超越师傅了！"}


# 巨流
PERSON_JU_LIU = \
    {"firstname": "巨", "lastname": "流", "title": "百兵堂钢刀舵舵主",
     "dongjing": -10, "gangrou": 9, "zhipu": 11, "yinyang": 7,
     "neigong": 48, "boji": 42, "jianfa": 17, "daofa": 72, "changbing": 33, "anqi": 21, "qimen": 10,
...
# 熊琦
PERSON_XIONG_QI = \
    {"firstname": "熊", "lastname": "琦", "title": "百兵堂金鞭舵舵主",
     "dongjing": -6, "gangrou": 20, "zhipu": -10, "yinyang": 13,
     "neigong": 54, "boji": 50, "jianfa": 30, "daofa": 30, "changbing": 31, "anqi": 23, "qimen": 71,
     "superskills": [{"id": "SUPERSKILL_JIANGHUXINFA", "learn": [0, 1, 2]},
                     {"id": "SUPERSKILL_YOUXIAXINFA", "learn": [0, 1, 2]},
                     {"id": "SUPERSKILL_POFENGBADAO", "learn": [0, 1, 2]}],
     "equipment": [],
...
# 武十全
PERSON_WU_SHIQUAN = \
    {"firstname": "武", "lastname": "十全", "title": "百兵堂总舵主",
     "dongjing": -3, "gangrou": 12, "zhipu": -18, "yinyang": 25,
     "neigong": 68, "boji": 52, "jianfa": 71, "daofa": 72, "changbing": 74, "anqi": 37, "qimen": 73,
     "superskills": [{"id": "SUPERSKILL_JIANGHUXINFA", "learn": [0, 1, 2]},
                     {"id": "SUPERSKILL_YOUXIAXINFA", "learn": [0, 1, 2]},
                     {"id": "SUPERSKILL_POFENGBADAO", "learn": [0, 1, 2]}],
     "equipment": [],
