...
SCRIPT_BATTLE_TUITION_1 = \
    [{"type": "Action.ContextPlayerChangeAction", "person": "{PERSON_PLAYER_TUITION}"},
...
SCRIPT_BATTLE_TUITION_2 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
     ...
     {"type": "Action.EventSwitchOnAction", "event": "EVENT_BATTLE_TUITION_2"},
     {"type": "Action.EventSwitchOnAction", "event": "EVENT_BATTLE_TUITION_MOVE_WRONG"}]


SCRIPT_BATTLE_TUITION_2_1 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
      "content": "不对，你需要移动到坐标(2, 2)的位置。"}]
     

SCRIPT_BATTLE_TUITION_3 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
     ...
     {"type": "Action.EventSwitchOnAction", "event": "EVENT_BATTLE_TUITION_3"}]


SCRIPT_BATTLE_TUITION_4 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
      "content": "现在又轮到你行动了，请你再次使用移动指令，行进到木人桩的身边吧。"},
     {"type": "Action.EventSwitchOnAction", "event": "EVENT_BATTLE_TUITION_4"}]


SCRIPT_BATTLE_TUITION_5 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
      "content": ["敌人已经在你的攻击范围内了，你可以使用【攻击】指令来攻击木人桩。",
                  "使用【攻击】指令时，需要先选择使用的技能，然后选择你要攻击的坐标，最后进行确认。",
                  "现在请对木人桩进行攻击吧。"]},
     {"type": "Action.EventSwitchOnAction", "event": "EVENT_BATTLE_TUITION_5"}]


SCRIPT_BATTLE_TUITION_6 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
     ...
     {"type": "Action.EventSwitchOnAction", "event": "EVENT_BATTLE_TUITION_ATTACK_SCOPE"}]
                  
                  
SCRIPT_BATTLE_TUITION_8 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
