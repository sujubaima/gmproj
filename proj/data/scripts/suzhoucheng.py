...
SCRIPT_INITIALIZE_2 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
     ...
     {"type": "Action.PersonSpeakAction", "talker": "{PERSON_ZHAO_YAYI_SUZHOU}",
      "content": ["常熟那块有个叫薛四彭的私盐贩子，因为犯事被官府通缉，于是就纠集了几个宵小，在长江边上结寨作乱。",
...
SCRIPT_WANPENGFEI_1 = \
    [{"type": "Action.PersonSpeakAction", 
     ...
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)", "next": "LABEL_1C",
...
SCRIPT_WANPENGFEI_3 = \
    [{"label": "LABEL_1C",
      ...
      "branches": [{"label": "LABEL_2A"},
                   {"label": "LABEL_2B"}]},
     {"label": "LABEL_2A",
      "type": "Action.PersonSpeakAction", "talker": "(plot.subject)", "next": "LABEL_2C",
      "content": "有何不可？"},
     {"label": "LABEL_2B",
      "type": "Action.PersonSpeakAction", "talker": "(plot.subject)", 
     ...
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)",  
      "content": ["咳，书生论侠，三句话不离宝剑。殊不知行走江湖，还是我这口单刀实用！",
...
SCRIPT_WANPENGFEI_4 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
     ...
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)", "label": "LABEL_SCRIPT_WANPENGFEI_2A",
      "content": "还没有，待会再回来找你。"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)", "next": "EOF",
      "content": "……"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)", "label": "LABEL_SCRIPT_WANPENGFEI_2B",
      "content": "完事了，我们出发！"},
...
SCRIPT_MAYUESHI_1 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)", 
     ...
     {"type": "Action.PersonSpeakAction", "talker": "{PERSON_WAN_PENGFEI}", 
     ...
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)", "next": 16, 
      "content": "那行吧，老板我看看这里都有什么。"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)", "next": 14,
      "content": "你说得对，咱们多买几件，以后多招几个女队员！"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)", "next": 16,
      "content": "大侠看看都要买什么？"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)", "next": 16,
...
DIALOG_YEZHONG_3 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)", 
     ...
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)", "next": 3,
     ...
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)", "next": 999,
      "content": "多谢，我会努力的。"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)", 
      "content": "多谢老哥，那我先告辞了。"}]
...
DIALOG_ZHANGXIN_1 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)", 
     ...
     #5
     {"type": "Action.PersonSpeakAction", "talker": "", 
     ...
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)", "next": 10,
...
SCRIPT_LUOGONGZI_1 = \
    [{"type": "Action.PersonSpeakAction", "talker": "{PERSON_LUO_GONGZI_SUZHOU}", 
      "content": "最近苏州城外匪盗作乱，耿知府天天招募豪杰说要剿匪，也没几个去投奔的。" +
                 "上次我路过南园，好像只有两个人在里头练武。"},
     {"type": "Action.PersonSpeakAction", "talker": "{PERSON_ZHAO_JUREN_SUZHOU}", 
...
DIALOG_DINGTIEJIANG_1 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)", 
     ...
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)", 
      "content": "给我讲讲修理装备的事吧。"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)", "next": 5,
...
DIALOG_LIANGZIYOU_1 = \
    [{"type": "Action.PersonSpeakAction", "talker": "",
     ...
     {"type": "Action.PersonSpeakAction", "talker": "{PERSON_LIANG_ZIYOU}",
      "content": "（唱）秋江岸边莲子多，采莲女儿棹船歌。花房莲实齐戢戢，争前兢折歌绿波。" + 
                 "恨逢长茎不得藕，断处丝多刺伤手。何时寻伴归去来？水远山长莫回首。"},
     {"type": "Action.PersonSpeakAction", "talker": "{PERSON_WEI_GONGSHENG}",
...
DIALOG_XUESIPENG_2 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
     ...
     {"type": "Action.PersonSpeakAction", "talker": "{PERSON_WANG_XIAOHU}",
...
SCRIPT_YUANWUYA_2 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
      "content": "小兄弟如此照顾生意，在下实在是感激不尽。在下还有一个不情之请，不知小兄弟能否帮忙？"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)",
      "content": "有什么事？"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
      "content": ["在下曾搜集到一部民间话本，名叫《忠义水浒传》，讲的乃是大宋宣和年间一百零八名好汉的故事。",
                  ...
                  "不知小兄弟能否替我前去造访一下这位老丐，略做些钩沉发微之举，好为在下提供点素材？"]},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)",
      "content": "你为什么自己不去？"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)",
      "content": "这件事对我有什么好处？"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)",
      "content": "请跟我讲讲丐帮的事情？"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)",
      "content": "举手之劳，等我途径丐帮，便会替夫子打听。"},
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)",
      "content": "既是上佳之作，你又何必狗尾续貂？此事恕我无法相助。"},
     {"type": "Pause"}]
...
DIALOG_FENGMENGLONG_1 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
     ...
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)", "next": 20,
     ...
     {"type": "Action.PersonSpeakAction", "talker": "(plot.subject)",     
      "content": "昆山腔又是什么？"},
     #15
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)", "next": 7,
