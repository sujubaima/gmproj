...
DIALOG_SHAOLINLUNWU = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.subject)", 
     ...
     {"type": "Action.PersonSpeakAction", "talker": "{PERSON_YUAN_LONG}", 
      "content": "这……小僧也有此疑惑……"},
     {"type": "Conditions", 
      "conditions": [{"type": "PersonInTeamCondition", "person": "{PERSON_LAN_ZIWEI}", "leader": "{PERSON_PLAYER}"}],
      "result": {"true": 3, "false": 7}},
     {"type": "Action.PersonSpeakAction", "talker": "{PERSON_LAN_ZIWEI}", 
     ...
     {"type": "Action.PersonSpeakAction", "talker": "{PERSON_SUONAN_RAODAN}", 
      "content": "他们表面上是在比武，实际上是在讨论佛理。觉因方丈使的是『摩诃无量掌』中的『如恒河沙』一式，" + 
