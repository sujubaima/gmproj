...
SCRIPT_GENGZHUQIAO_1 = \
    [{"type": "Action.PersonSpeakAction",
      "content": "（耿朱桥年约四十余岁，留着三绺长须，头上罩着一顶四方巾，看上去既不像武林人士，也不像朝廷命官，反倒有几分闲散文人的样子。）"},
     ...
     {"type": "Action.PersonSpeakAction", "talker": "(plot.object)", "next": "LABEL_I",
     ...
     {"type": "Include", "break": True,
      "subject": "{PERSON_PLAYER}", "object": "{PERSON_GENG_ZHUQIAO}", "script": "SCRIPT_BATTLE_TUITION_1"},
     # LABEL_J
     {"label": "LABEL_J",
      "type": "Action.PersonSpeakAction",
...
SCRIPT_GENGZHUQIAO_2 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.subject)",
     ...
     # LABEL_A
     {"label": "LABEL_A",
      "type": "Action.PersonSpeakAction", "talker": "(plot.subject)", "next": "EOF",
      "content": "我要报名参与剿匪！"},
     # LABEL_B
     {"label": "LABEL_B",
      "type": "Action.PersonSpeakAction", "talker": "(plot.subject)",
...
SCRIPT_LUANTAN_1 = \
    [{"type": "Action.PersonSpeakAction",
     ...
     {"type": "Action.EventSwitchOnAction", "event": "EVENT_BATTLE_LUANTAN_WIN"},
     {"type": "Action.EventSwitchOnAction", "event": "EVENT_BATTLE_LUANTAN_LOSE"},
     {"type": "Control.BattleStartControl", "break": True,
      "subject": "{TEAM_PERSON_PLAYER}", "object": "{TEAM_PERSON_LUAN_TAN}", "death": False},
     # LABEL_B
     {"label": "LABEL_B",
      "type": "Action.PersonSpeakAction", "talker": "(plot.subject)",
     ...
     {"type": "Script", "type": "Action.PersonAttitudeChangeAction", 
...
SCRIPT_LUANTAN_2 = \
    [{"type": "Action.PersonSpeakAction", "talker": "(plot.object)",
     ...
     {"type": "Action.PersonSpeakAction", "talker": "{PERSON_SHI_JINGYAN}",
     ...
     {"type": "Script", "type": "Action.TeamIncludePersonAction", "next": "EOF",
