...
DIALOG_INITIALIZE_1 = \
    [{"style": "Speak", "talker": "", 
      "content": "XXXX年X月X日，连续加班N个通宵的{PERSON_PLAYER_NAME}终于晕倒在了岗位上，当他再次睁开双眼的时候，发现自己……"}]


DIALOG_INITIALIZE_2 = \
    [{"style": "Speak", "talker": "subject", 
      "content": "唉，这是什么鬼地方，怎么所有的东西都长得跟字符串似的？"},
     {"style": "Speak", "talker": "subject", 
      "content": "（努力回忆）我之前好像是在公司敲代码来着，但后面发生了什么我完全想不起来了……"},
     {"style": "Speak", "talker": "subject", 
      "content": "总之眼前这一切太奇怪了，我得找个人问问，看看到底是怎么回事。"}]
...
DIALOG_INITIALIZE_3 = \
    [{"style": "Speak", "talker": "subject", 
     ...
     {"style": "Speak", "talker": "object", 
      "content": "这里是苏州城。"},
     {"style": "Speak", "talker": "subject", 
      "content": "苏州？苏州怎么长得这个鬼样子？"},
     {"style": "Speak", "talker": "object", 
      "content": "嗯？我们苏州好山好水，你有什么不满意？"},
     {"style": "Speak", "talker": "subject", 
      "content": "我……我是说，苏州长得这个样子，真是鬼斧神工。"},
     {"style": "Speak", "talker": "object", 
      "content": "这还差不多。"},
     {"style": "Speak", "talker": "subject", 
      "content": "（自言自语）这得多强大的脑补能力才能看出来好山好水……"},
     {"style": "Speak", "talker": "object",
      "content": "小兄弟，我听你说话蛮有意思，你是从哪里来的？"},
     {"style": "Speak", "talker": "subject", 
      "content": "我……是北京来的……不过我隐隐有种感觉，咱们所想的北京可能不太一样……"},
     {"style": "Speak", "talker": "object", 
      "content": "北京啊，不就是我们大明朝的都城吗，能有什么不一样？"},
     {"style": "Speak", "talker": "subject", 
      "content": "什么，你说什么？明朝？现在是明朝？"},
     {"style": "Speak", "talker": "object", 
      "content": "对啊？今年是大明万历三十七年，你不会连这都不知道吧？"},
     {"style": "Speak", "talker": "subject", 
      "content": "并不知道……"},
     {"style": "Speak", "talker": "object", 
      "content": "唉，现在的年轻人真是一点时间观念都没有。"},
     {"style": "Speak", "talker": "subject", 
      "content": "唉……没想到居然穿越了，这我该怎么回家……"},
     {"style": "Speak", "talker": "object", 
      "content": "小兄弟你别着急，我看出来了，你是一个人在外飘零，想家了对吧。依我看哪，既来之则安之，我们苏州城里好玩的物事多得很，你多逛一逛，很快就流连忘返了。"},
     {"style": "Speak", "talker": "subject", 
      "content": "谢谢，再好玩我也要回家。"},
     {"style": "Speak", "talker": "object", 
      "content": "（摇头）行行行，那你回家吧。真是个怪人……"}]
      
      
DIALOG_INITIALIZE_4 = [{"style": "Speak", "talker": "subject", 
                        "content": "唉，话虽如此，可现在一点儿头绪也没有，也只能先到处逛逛了。"}]
    ...
    [{"style": "Speak", "talker": "object",
     ...
     {"style": "Speak", "talker": "object",
      "content": ["哈？爷在长江边上这么些年，还第一次听见有人这么说话。既然你如此坦诚，爷就不为难你了。",
                  "不过你可得记住，爷可不是什么侠义之士，爷就是个彻头彻尾的贼枭，只是看这世道不惯，就带了几个兄弟啸聚山林。",
                  "原本想的倒是干些劫富济贫，替天行道的举动，只可惜入了这行，可就身不由己了。管你们是贫是富，又与爷何干？",
                  "所以你回去告诉你的亲戚朋友，下次见了爷，可别自己撞上来！"]},
     {"style": "Speak", "talker": "subject",
      "content": "好，我回去就告诉他们。"},
     {"style": "Speak", "talker": "subject",
     ...
     {"style": "Speak", "talker": "object",
      "content": "……"},
     {"style": "Speak", "talker": "subject",
      "content": "既然侠义之心未泯，容我叫薛大哥一句义士。希望薛义士不忘初心，砥砺前行；牢记使命，不断奋斗……"},
     {"style": "Speak", "talker": "object",
      "content": "什么乱七八糟的，废话真多！快给我滚！"}]
...
DIALOG_XUESIPENG_2 = \
    [{"style": "Speak", "talker": "object",
     ...
     {"style": "Speak", "talker": "subject",
      "content": ["不管怎么样，薛大哥还是要小心为妙。第一，以耿朱桥在江湖的名气，请到其他门派的高手并不是什么难事。",
                  "先不说远的，就这南京丐帮、杭州风云盟，只要把你说成无恶不作的恶匪，他们八成是要仗义驰援的。",
                  "再者，就算武林同道不来，耿朱桥也不会一直稳居府衙，避而不出。他现在不出手，无非是因为身居公职，不便以江湖规矩行事。",
...
DIALOG_YUANWUYA_1 = \
    [{"style": "Speak", "talker": "object",
     ...
     {"style": "Speak", "talker": "object",
      "content": ["还不是因为生意不景气，破产了呗。以前房子的地契都被我给当了，我还上哪卖书去啊？", 
                  "好在寒山寺方丈看在我以前给庙里捐了不少佛经和香火钱，让我在这长期挂单，顺便清空一下存货。只是卖书的钱，不得不与寺庙平分了。"]},
     {"style": "Speak", "talker": "subject",
      "content": "那看看你都有什么书卖吧。"},
     {"style": "Speak", "talker": "object",
